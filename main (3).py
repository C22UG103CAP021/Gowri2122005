''' implement a class player that represents a cricket player. the player class should have a''' implement a class player that represents a cricket player. the player class should have a
